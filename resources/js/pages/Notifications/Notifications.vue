        ...
        >
            <b-row>
                <b-col lg="4" xs="12">
                    ...
                    <p>
                        There are few position options available for
                        notifications. You can click any of them to change
                ...
                <b-col lg="4" xs="12">
                    ...
                    <p>
                        Just few lines of code to instantiate a notifications
                        object. Does not require passing any options:
                    </p>
        ...
        addInfoNotification() {
            this.$toasted.info("Launching thermonuclear war...", {
                action: {
                    ...
                    onClick: (e, toastObject) => {
                        toastObject
                            .text("Thermonuclear war averted")
                            .goAway(1000);
                    }
                }
            });
