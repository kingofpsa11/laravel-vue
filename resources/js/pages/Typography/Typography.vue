        ...
        <b-row>
            <b-col xs="12" md="6">
                ...
                >
                    ...
                    <div
                        class="widget-padding-md w-100 h-100 text-left border rounded"
                    >
                        <b-row>
                            <b-col sm="6">
                                <h1>h1. Heading</h1>
                    ...
                    >
                        <p class="lead">
                            Sing App is admin dashboard template built with
                            Bootstrap
                        </p>
                    </div>
                </Widget>
                    ...
                    >
                        <blockquote class="blockquote">
                            <p>
                                ...
                                build your own, and let it gb-row, be like
                                water. Empty your mind, be formless, shapeless —
