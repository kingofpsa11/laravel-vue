    ...
    <b-navbar class="header d-print-none">
        <b-nav>
            <b-nav-item>
                ...
                >
                    <span
                        class="rounded rounded-lg bg-gray text-white d-md-none"
                    >
                        <i class="la la-bars la-lg" />
                    </span>
        ...
        <b-nav class="ml-auto">
            ...
            >
                <template slot="button-content">
                    ...
                    <span class="small"
                        >Philip <span class="fw-semi-bold">Smith</span></span
                    >
                    <span class="ml-1 circle bg-warning text-white fw-bold"
                        >13</span
                    >
                </template>
                <Notifications />
            ...
            <b-nav-item>
                ...
                <div
                    ...
                    :class="{ 'notification-hidden': !chatNotificationPopover }"
                >
                    <div class="chat-notification-inner">
                        ...
                        <p class="text">
                            Hi there! <br />
                            This is a completely new version of Sing App <br />
